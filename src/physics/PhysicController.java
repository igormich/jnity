...
public class PhysicController {
	...
	public static final Vector3f NORMAL_GRAVIRY = new Vector3f(0, -9.8f, 0);
	...
	public void clear() {
		bodies = new HashMap<Object3d, RigidBody>();
		collisions = new HashMap<Pair<RigidBody, RigidBody>, PersistentManifold>();
		BroadphaseInterface broadphase = new DbvtBroadphase();
		DefaultCollisionConfiguration collisionConfiguration = new DefaultCollisionConfiguration();
